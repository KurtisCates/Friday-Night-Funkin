...
class HUD extends FlxTypedGroup<FlxSprite>
{
	...
	public function updateStrumLine(song:SwagSong, daNote:Note)
	{
	...
	public function generateStaticArrows(player:Int, playerStrums:FlxTypedGroup<FlxSprite>,
		player2Strums:FlxTypedGroup<FlxSprite>, strumLineNotes:FlxTypedGroup<FlxSprite>):Void
	{
		for (i in 0...4)
		{
